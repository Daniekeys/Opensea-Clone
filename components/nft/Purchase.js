...
const MakeOffer = ({ isListed, selectedNft, listings, marketPlaceModule }) => {
  ...
  useEffect(() => {
    ...
    ;(async () => {
      setSelectedMarketNft(
        listings.find(
          (marketNft) =>
            marketNft.asset?.id.toString() == selectedNft.metadata.id.toString()
        )
      )
    })()
  ...
  const buyItem = async (
    ...
    await marketPlaceModule
      .buyoutListing(parseInt(listingId.toString()), quantityDesired)
                  ...
                  <form onSubmit={sellItem}>
                    <div className={style.modalContent}>
                      ...
                      <div className={style.modalBody}>
                        <p className="my-2 text-sm leading-relaxed text-slate-400">
                          Service Fee 2.5%
                        </p>
                        <div className="mb-6">
                          <label
                      ...
                      <div className={style.modalFooter}>
                        ...
                        <button
                          className="mr-1 mb-1 rounded bg-sky-500 px-6 py-3 text-sm font-bold uppercase text-white shadow outline-none transition-all duration-150 ease-linear hover:shadow-lg focus:outline-none active:bg-sky-600"
                          type="submit"
                        >
                          Complete listing
                        </button>
